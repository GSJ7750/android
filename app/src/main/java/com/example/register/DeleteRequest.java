...
public class DeleteRequest extends StringRequest{
    ...
    final static private String URL = "http://skj.dothome.co.kr/Delete.php";
    private Map<String, String> parameters;
    public DeleteRequest(int lost_ID, Response.Listener<String> listener){
        super(Request.Method.POST, URL, listener, null);//Post방식임
        parameters = new HashMap<>();//해쉬맵 생성후 parameters 변수에 값을 넣어줌
        parameters.put("lost_ID", String.valueOf(lost_ID));
    }
    @Override
