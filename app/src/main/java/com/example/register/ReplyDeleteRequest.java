...
public class ReplyDeleteRequest extends StringRequest{
    ...
    final static private String URL = "http://skkj.dothome.co.kr/ReplyDelete.php";
    private Map<String, String> parameters;
    public ReplyDeleteRequest(int ReplyIndex, Response.Listener<String> listener){
        super(Request.Method.POST, URL, listener, null);//Post방식임
        parameters = new HashMap<>();//해쉬맵 생성후 parameters 변수에 값을 넣어줌
        parameters.put("ReplyIndex", String.valueOf(ReplyIndex));
    }
    @Override
