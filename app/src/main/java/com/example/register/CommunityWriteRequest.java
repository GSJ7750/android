...
public class CommunityWriteRequest extends StringRequest {

    final static private String URL = "http://skj.dothome.co.kr/Cm_Register.php";
    private Map<String,String> map;
    public CommunityWriteRequest(String Cm_Title, String Cm_Content, String Cm_Time, String Cm_User, String Cm_Password, Response.Listener<String> listener){
